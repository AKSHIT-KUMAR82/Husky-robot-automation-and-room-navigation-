...
for joint in range (0,19,18):
    T = 0.02
    d = np.loadtxt('/home/akshit/catkin_workspace/src/husky_traj/record.csv', delimiter=',', skiprows=1)
    t1 = 0.025
    data = d[:, 1:]
    ...
    def main():
        best_individual, best_mse = genetic_algorithm(population_size=50, generations=10)
